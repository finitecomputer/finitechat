    ...
    *,
    ...
    lines = [
        ...
        *[
        ...
        "chat event IDs plus backup/restore flags. Build",
        ...
        "result must match the generated handoff/config expectations for",
        "container name, image digest, storage backend, and restore tag.",
        "",
        "```json",
        "{",
        '  "expected": {',
